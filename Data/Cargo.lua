...
PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8921, --[[Cargo MechanizedDepotConcrete description]] "Stores <concrete(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotConcrete",
	kg = 10000,
	locked = true,
	name = T(8846, --[[Cargo MechanizedDepotConcrete name]] "Concrete Storage"),
	price = 999000000,
})

PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8906, --[[Cargo MechanizedDepotElectronics description]] "Stores <electronics(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotElectronics",
	kg = 10000,
	locked = true,
	name = T(8828, --[[Cargo MechanizedDepotElectronics name]] "Electronics Storage"),
	price = 999000000,
})

PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8907, --[[Cargo MechanizedDepotFood description]] "Stores <food(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotFood",
	kg = 10000,
	locked = true,
	name = T(8830, --[[Cargo MechanizedDepotFood name]] "Food Storage"),
	price = 999000000,
})

PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8908, --[[Cargo MechanizedDepotFuel description]] "Stores <fuel(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotFuel",
	kg = 10000,
	locked = true,
	name = T(8832, --[[Cargo MechanizedDepotFuel name]] "Fuel Storage"),
	price = 999000000,
})

PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8909, --[[Cargo MechanizedDepotMachineParts description]] "Stores <machineparts(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotMachineParts",
	kg = 10000,
	locked = true,
	name = T(8834, --[[Cargo MechanizedDepotMachineParts name]] "Machine Parts Storage"),
	price = 999000000,
})

PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8910, --[[Cargo MechanizedDepotMetals description]] "Stores <metals(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotMetals",
	kg = 10000,
	locked = true,
	name = T(8836, --[[Cargo MechanizedDepotMetals name]] "Metals Storage"),
	price = 999000000,
})

PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8911, --[[Cargo MechanizedDepotPolymers description]] "Stores <polymers(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotPolymers",
	kg = 10000,
	locked = true,
	name = T(8838, --[[Cargo MechanizedDepotPolymers name]] "Polymers Storage"),
	price = 999000000,
})

PlaceObj('Cargo', {
	SortKey = 18006000,
	description = T(8912, --[[Cargo MechanizedDepotRareMetals description]] "Stores <preciousmetals(UIMaxStorageAmount)>. Some resources will be transported to other depots within Drone range."),
	group = "Refab",
	id = "MechanizedDepotRareMetals",
	kg = 10000,
	locked = true,
	name = T(8841, --[[Cargo MechanizedDepotRareMetals name]] "Rare Metals Storage"),
	price = 999000000,
})
