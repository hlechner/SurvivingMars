...
PlaceObj('Scenario', {
	...
	PlaceObj('ScenarioSequence', {
		...
		PlaceObj('SA_WaitMessage', {
			...
			'voiced_text', T(8360, --[[voice:billionaire]] "“No, aliens did not build the pyramids – human beings built the pyramids with ingenuity and hard work."),
