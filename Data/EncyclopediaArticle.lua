...
PlaceObj('EncyclopediaArticle', {
	...
	group = "Vehicles",
	id = "RCSafari",
	image = "UI/Encyclopedia/RCSafari.tga",
	text = T(158719221355, --[[EncyclopediaArticle Vehicles RCSafari text]] "The RC Safari is a remote-controlled vehicle that is used to take colonists with the <em>Tourist</em> trait on trips across the surface of Mars. Tourists gain <em>Satisfaction</em> from traveling past various sights. Sights are split into categories which generate a certain amount of Satisfaction each. \n\n<em>Sceneries</em>: Rock Formations & Vistas \n\n<em>Hotspots</em>: Geyser, Permanent Cold Wave Zone, Spirals, Unresearched Anomalies\n\n<em>Domes</em>: All domes, Spire Buildings increase the amount of satisfaction domes generate\n\n<em>Wonders</em>: All wonders\n\n<em>Spectacular Buildings</em>: Drone Assembler, Moxie, MDS Laser, Outside Ranch\n\nSeeing multiple sights of the same category decreases the <em>Satisfaction</em> they generate, so plan the safari routes carefully.\n\n<center><image UI/Common/rollover_line.tga 2000> <left>\n\nThe Safari Rovers were created to give tourists an unforgettable experience to share with those back on Earth. The publicity generated by the droves of satisfied tourists has helped keep the Mars project relevant. Safari Rovers are fully automated, providing a wide range of amenities and thrills to anyone willing to pay the steep fare."),
	title_id = "RCSafari",
	title_text = T(542076487006, --[[EncyclopediaArticle Vehicles RCSafari title_text]] "RC Safari"),
})
...
PlaceObj('EncyclopediaArticle', {
	...
	image = "UI/Encyclopedia/RechargeStation.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	image = "UI/Encyclopedia/UniversalDepot.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	image = "UI/Encyclopedia/WindTurbineLarge.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	group = "GameMechanics",
	id = "Life Support",
	image = "UI/Encyclopedia/MOXIE.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	group = "GameMechanics",
	id = "Research",
	image = "UI/Encyclopedia/ScienceInstitute.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	group = "GameMechanics",
	id = "Colonists",
	image = "UI/Encyclopedia/LivingQuartersSmall.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	image = "UI/Encyclopedia/Shuttle.tga",
	text = T(5419, --[[EncyclopediaArticle GameMechanics Colonists - Moving Between Domes text]] "Colonists may migrate to new Domes within walking distance of their current position, or farther away when Shuttle transport becomes available.\n\nHomeless Colonists will travel to another accessible Dome with available residential space.\n\nEach <em>Dome</em> can be set up to filter Colonists by age, specialization and other traits. Colonists with ANY of the must include traits, or ANY of the desired traits and NONE of the undesired ones will remain in the Dome. Others will seek another Dome with available living space and filter that matches their traits."),
...
PlaceObj('EncyclopediaArticle', {
	...
	image = "UI/Encyclopedia/School.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	id = "Tourists",
	image = "UI/Encyclopedia/LivingQuartersSmall.tga",
	text = T(548840736550, --[[EncyclopediaArticle GameMechanics Tourists text]] "Tourists are <em>Colonists</em> who visit Mars for recreation, and are brought in from Earth through the resupply screen. They stay on Mars for 5 sols, looking to go home afterwards.\n\nUpon returning to earth, each Tourist gives their holiday a rating based on their <em>Satisfaction</em> stat. They generate funds and new applicants based on their rating. Tourists with the <em>Saint</em>, <em>Celebrity</em> and <em>Genius</em> Traits give extra rewards.\n\nEvery Tourist has the <em>Satisfaction</em> stat, which tracks how much they've enjoyed their holiday. Satisfaction is increased by raising stats and through certain buildings or vehicles (<em>Hotels</em>, <em>Low-G Amusement Parks</em>, and <em>RC Safaris</em> )."),
	title_id = "Tourist",
	title_text = T(914217898717, --[[EncyclopediaArticle GameMechanics Tourists title_text]] "Tourists"),
})
...
PlaceObj('EncyclopediaArticle', {
	...
	group = "GameMechanics",
	id = "Exploration",
	image = "UI/Encyclopedia/SensorTower.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	group = "GameMechanics",
	id = "Wonders",
	image = "UI/Encyclopedia/ArtificialSun.tga",
...
PlaceObj('EncyclopediaArticle', {
	...
	group = "GameMechanics",
	id = "Landscaping",
	image = "UI/Encyclopedia/Landscaping.tga",
	text = T(516474208322, --[[EncyclopediaArticle GameMechanics Landscaping text]] "Landscaping allows you to flatten and shape the Martian surface for practical or aesthetic reasons. You may also create Ramps to connect different levels of the terrain.\n\nThe process is facilitated by Drones, which extract Waste Rock to lower the ground or dump additional Waste Rock to raise it."),
	title_id = "Landscaping",
	title_text = T(537503650109, --[[EncyclopediaArticle GameMechanics Landscaping title_text]] "<new_in('armstrong')>Landscaping"),
})
