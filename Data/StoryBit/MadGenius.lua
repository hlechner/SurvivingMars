...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitOutcome', {
		'Prerequisites', {},
		'Weight', 50,
		'VoicedText', T(951045166234, --[[voice:narrator]] 'After some time the genius strides out with a proud smile. "Behold my creation!" Behind rolls a clunky jury-rigged Drone with an immense booster on its back.'),
