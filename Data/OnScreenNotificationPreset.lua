...
PlaceObj('OnScreenNotificationPreset', {
	...
	group = "Anomalies",
	id = "CompletedSpecialProject",
	image = "UI/Icons/Notifications/New/rocket_3.tga",
	popup_preset = "CompletedCloudSeeding",
	priority = "NormalTerraforming",
	title = T(12058, --[[OnScreenNotificationPreset CompletedSpecialProject title]] "Completed Special Project"),
})
...
PlaceObj('OnScreenNotificationPreset', {
	...
	fx_action = "UINotificationAnomaly",
	group = "Anomalies",
	id = "NewSpecialProjects",
	image = "UI/Icons/Notifications/New/new_planetary_anomalies_3.tga",
	priority = "NormalTerraforming",
	text = T(155422354340, --[[OnScreenNotificationPreset NewSpecialProjects text]] "<project_name>"),
	title = T(11911, --[[OnScreenNotificationPreset NewSpecialProjects title]] "New Special Project"),
})

PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/new_anomaly.tga",
	SortKey = 1001600,
	expiration = 150000,
	fx_action = "UINotificationAnomaly",
	group = "Anomalies",
	id = "NewAnomalies",
	image = "UI/Icons/Notifications/New/new_anomaly.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/research.tga",
	SortKey = 1001900,
	close_on_read = true,
	expiration = 150000,
...
PlaceObj('OnScreenNotificationPreset', {
	...
	fx_action = "UINotificationResearch",
	group = "Anomalies",
	id = "PlanetaryAnomaly_BreakthroughDiscovered",
	image = "UI/Icons/Notifications/New/research.tga",
	text = T(11427, --[[OnScreenNotificationPreset PlanetaryAnomaly_BreakthroughDiscovered text]] "Breakthrough discovered: <name>"),
	title = T(544703564762, --[[OnScreenNotificationPreset PlanetaryAnomaly_BreakthroughDiscovered title]] "Planetary Anomaly Analyzed"),
	voiced_text = T(7040, --[[voice:aide]] "Breakthrough discovered"),
})
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/anomaly_analyzed.tga",
	SortKey = 1002100,
	expiration = 150000,
	fx_action = "UINotificationAnomaly",
	group = "Anomalies",
	id = "AnomalyAnalyzed",
	image = "UI/Icons/Notifications/New/anomaly_analyzed.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	fx_action = "UINotificationAnomaly",
	group = "Anomalies",
	id = "PlanetaryAnomaly_TechUnlockAnomalyAnalyzed",
	image = "UI/Icons/Notifications/New/anomaly_analyzed.tga",
	text = T(5651, --[[OnScreenNotificationPreset PlanetaryAnomaly_TechUnlockAnomalyAnalyzed text]] "New Techs are available for research"),
	title = T(325837540174, --[[OnScreenNotificationPreset PlanetaryAnomaly_TechUnlockAnomalyAnalyzed title]] "Planetary Anomaly Analyzed"),
	voiced_text = T(7042, --[[voice:aide]] "Anomaly analyzed"),
})
...
PlaceObj('OnScreenNotificationPreset', {
	...
	fx_action = "UINotificationAnomaly",
	group = "Anomalies",
	id = "PlanetaryAnomaly_GrantRP",
	image = "UI/Icons/Notifications/New/anomaly_analyzed.tga",
	text = T(10285, --[[OnScreenNotificationPreset PlanetaryAnomaly_GrantRP text]] "Gained <resource(points,resource)>"),
	title = T(381507744281, --[[OnScreenNotificationPreset PlanetaryAnomaly_GrantRP title]] "Planetary Anomaly Analyzed"),
	voiced_text = T(7042, --[[voice:aide]] "Anomaly analyzed"),
})
...
PlaceObj('OnScreenNotificationPreset', {
	...
	group = "System",
	id = "NewFeatures",
	popup_preset = "NewFeatures",
	priority = "CriticalBlue",
	text = T(365036183955, --[[OnScreenNotificationPreset NewFeatures text]] "Surviving Mars has been updated"),
	title = T(294021715662, --[[OnScreenNotificationPreset NewFeatures title]] "New Features"),
})

PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/mystery_log_2.tga",
	SortKey = 1009000,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	...
	image = "UI/Icons/Notifications/New/mystery_log.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/no_power_2.tga",
	SortKey = 1000100,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	...
	group = "Default",
	id = "NoPower",
	image = "UI/Icons/Notifications/New/no_power_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/new_deposit.tga",
	SortKey = 1000600,
	expiration = 150000,
	fx_action = "UINotificationResource",
	group = "Default",
	id = "NewDeposits",
	image = "UI/Icons/Notifications/New/new_deposit.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/funding.tga",
	SortKey = 1000800,
	expiration = 150000,
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/rocket.tga",
	SortKey = 1001400,
	expiration = 150000,
	fx_action = "UINotificationResource",
	group = "Default",
	id = "ResupplyArrived",
	image = "UI/Icons/Notifications/New/rocket.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	image = "UI/Icons/Notifications/New/placeholder.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	group = "Default",
	id = "FuelDestroyed",
	image = "UI/Icons/Notifications/New/placeholder_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/placeholder.tga",
	SortKey = 1001800,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/research_2.tga",
	ShowVignette = true,
	SortKey = 1002800,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/fractured_dome_2.tga",
	SortKey = 1003000,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	...
	group = "Default",
	id = "FracturedDome",
	image = "UI/Icons/Notifications/New/fractured_dome_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/oxygen_2.tga",
	ShowVignette = true,
	SortKey = 1003700,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	...
	group = "Default",
	id = "NoOxygen",
	image = "UI/Icons/Notifications/New/oxygen_2.tga",
	priority = "Critical",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/water_2.tga",
	ShowVignette = true,
	SortKey = 1003800,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	...
	group = "Default",
	id = "NoWater",
	image = "UI/Icons/Notifications/New/water_2.tga",
	priority = "Critical",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	image = "UI/Icons/Notifications/New/no_life_support_2.tga",
	priority = "Critical",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/deposit_depleted.tga",
	SortKey = 1004100,
	expiration = 150000,
	fx_action = "UINotificationResource",
	group = "Default",
	id = "DepletedDeposits",
	image = "UI/Icons/Notifications/New/deposit_depleted.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	image = "UI/Icons/Notifications/New/not_working_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/milestone_complete.tga",
	SortKey = 1004700,
	close_on_read = true,
	expiration = 300000,
	...
	image = "UI/Icons/Notifications/New/milestone_complete.tga",
	text = T(756643722601, --[[OnScreenNotificationPreset MilestoneComplete text]] "<display_name>: <research(reward_research)>"),
...
PlaceObj('OnScreenNotificationPreset', {
	...
	id = "GoalCompleted",
	image = "UI/Icons/Notifications/New/milestone_complete.tga",
	text = T(10284, --[[OnScreenNotificationPreset GoalCompleted text]] "Reward: <reward_description>"),
	title = T(10283, --[[OnScreenNotificationPreset GoalCompleted title]] "Goal Completed!"),
})
...
PlaceObj('OnScreenNotificationPreset', {
	...
	fx_action = "UINotificationMystery",
	group = "Default",
	id = "DestoyedBuildings",
	image = "UI/Icons/Notifications/New/placeholder_2.tga",
	priority = "Important",
	text = T(988191445076, --[[OnScreenNotificationPreset DestoyedBuildings text]] "Buildings destroyed: <count>"),
	title = T(221683525008, --[[OnScreenNotificationPreset DestoyedBuildings title]] "Buildings Destroyed"),
})
...
PlaceObj('OnScreenNotificationPreset', {
	...
	group = "Default",
	id = "RefugeeRocket",
	image = "UI/Icons/Notifications/New/colonist.tga",
	title = T(8123, --[[OnScreenNotificationPreset RefugeeRocket title]] "Refugee Rocket"),
})

PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/scan_2.tga",
	ShowVignette = true,
	SortKey = 1007700,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	...
	image = "UI/Icons/Notifications/New/scan.tga",
	priority = "CriticalBlue",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/scan.tga",
	SortKey = 1007800,
	expiration = 150000,
	group = "Default",
	id = "SectorScanned",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/drone.tga",
	SortKey = 1008200,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	...
	group = "Default",
	id = "OrphanedDrones",
	image = "UI/Icons/Notifications/New/drone_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/food.tga",
	SortKey = 1008400,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	expiration = 150000,
	...
	group = "Default",
	id = "CropsFailed",
	image = "UI/Icons/Notifications/New/food_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	image = "UI/Icons/Notifications/New/drone.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/timer_2.tga",
	SortKey = 1009300,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	dismissable = false,
	...
	group = "Default",
	id = "ChallengeTimer",
	image = "UI/Icons/Notifications/New/timer_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	VignettePulseDuration = 2000,
	group = "Default",
	id = "DestroyedVehicles",
	image = "UI/Icons/Notifications/New/drone_2.tga",
	priority = "Important",
	text = T(10953, --[[OnScreenNotificationPreset DestroyedVehicles text]] "Drones: <drones> Rovers: <rovers>"),
	title = T(10954, --[[OnScreenNotificationPreset DestroyedVehicles title]] "Destroyed Vehicles"),
})
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/colonist_2.tga",
	SortKey = 1001000,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	expiration = 150000,
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/cold_wave_2.tga",
	SortKey = 1002300,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	dismissable = false,
	...
	group = "Disasters",
	id = "ColdWave",
	image = "UI/Icons/Notifications/New/cold_wave_2.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/meteor_storm_2.tga",
	SortKey = 1002600,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	dismissable = false,
	...
	group = "Disasters",
	id = "MeteorStorm",
	image = "UI/Icons/Notifications/New/meteor_storm_2.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/dust_storm_2.tga",
	SortKey = 1003100,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	dismissable = false,
	...
	group = "Disasters",
	id = "normalDustStorm",
	image = "UI/Icons/Notifications/New/dust_storm_2.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/timer.tga",
	SortKey = 1005300,
	dismissable = false,
	fx_action = "UINotificationMystery",
	group = "Mystery",
	id = "Mystery1Counter",
	image = "UI/Icons/Notifications/New/timer.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/placeholder_2.tga",
	SortKey = 1005800,
	VignetteImage = "UI/Onscreen/onscreen_gradient_red.tga",
	VignettePulseDuration = 2000,
	dismissable = false,
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/no_life_support.tga",
	SortKey = 1006300,
	dismissable = false,
	fx_action = "UINotificationMystery",
	group = "Mystery",
	id = "Mystery8InfectionLevel",
	image = "UI/Icons/Notifications/New/no_life_support.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	ImagePreview = "UI/Icons/Notifications/New/mystery_log.tga",
	SortKey = 1007500,
	dismissable = false,
	fx_action = "UINotificationMystery",
	group = "Mystery",
