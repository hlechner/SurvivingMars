...
DefineClass.Constructable = {
	...
	properties = {
		...
		{ template = true, name = T(12706, "Exotic Minerals Cost"),     id = "construction_cost_PreciousMinerals",    category = "Construction", editor = "number", default = 0, scale = const.ResourceScale, modifiable = true},
--		{ template = true, name = T{"Water Cost"},           id = "construction_cost_Water",    category = "Construction", editor = "number", default = 0, scale = const.ResourceScale, modifiable = true},
		...
		{ template = true, name = T(12261, "Waste Rock Cost"),     id = "construction_cost_WasteRock",    category = "Construction", editor = "number", default = 0, scale = const.ResourceScale, modifiable = true},		{ template = true, name = T(132, "Construction Entity"),  id = "construction_entity", category = "Construction", editor = "dropdownlist", items = function() return GetBuildingEntities(false) end, default = false },
		...
		{ template = true, name = "Can Resize During Placement", no_edit = true, id = "can_resize_during_placement", category = "Construction", editor = "bool", default = false },
		{ template = true, name = T(11570, "Starting Angle (deg)"),      id = "starting_angle",     category = "Construction", editor = "number", default = 0, scale = 60, },
		...
		{ template = true, name = T(13759, "Can be built only once"),        id = "build_once",     category = "Construction", editor = "bool", default = false, help = "Whether the building can be constructed multiple times", },
