DefineClass.NetworkNode =
{
	...
	properties = {
		{ template = true, modifiable = true, category = "Spire", name = T(679, "Performance boost"), id = "performance_boost", editor = "number", default = 20, help = "Performance boost (int percent) to all research buildings in the same dome (for 100% performance of this building)" }
	},
