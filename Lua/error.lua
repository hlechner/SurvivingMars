...
MessageText["pops"]["add-silently-failed"]							= T(12813, "Can not connect this Paradox Account to your Microsoft Account.")
MessageText["pops"]["interactive-add-failed"]						= T(12814, "Can not connect this Microsoft Account to your Paradox Account.")
MessageText["pops"]["resolve-with-ui-failed"]						= T(12815, "The game did not receive permission to access your profile info.")
MessageText["pops"]["xsts-token-not-found"]							= T(12816, "Can not fetch XSTS token. Your Microsoft account could not be authenticated.")
MessageText["pops"]["xgame-not-initialized"]						= T(12817, "Can not initialize the GRDK")
