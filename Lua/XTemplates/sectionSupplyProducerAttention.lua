...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateTemplate', {
		...
		'OnContextUpdate', function (self, context, ...)
			self:SetVisible(context and context:IsKindOfClasses("WaterProducer") and context.water and context.water:UIShouldShowDemandAttention() or context and context:IsKindOfClasses("AirProducer") and context.air and context.air:UIShouldShowDemandAttention() and true)
		end,
