...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateTemplate', {
		...
		PlaceObj('XTemplateWindow', {
			'__dlc', "prunariu",
			'__context_of_kind', "Track",
			'__condition', function (parent, context) return IsDlcAvailable("prunariu") end,
			'__class', "XText",
			'Id', "idTrackTrainCount",
			'Padding', box(0, 0, 0, 0),
			'VAlign', "center",
			'MinWidth', 140,
			'HandleMouse', false,
		...
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					'comment', "add train",
					'__dlc', "prunariu",
					'__condition', function (parent, context) return IsKindOf(context, "Station") and not IsGameRuleActive("EasyTrains") end,
					'__class', "XTextButton",
					'RolloverTemplate', "Rollover",
					'RolloverAnchor', "right",
					'RolloverAnchorId', "node",
					'RolloverText', T(14370, --[[XTemplate TransportationOverviewRow RolloverText]] "Trains constructed here can be assigned to connected Tracks.\r\n\r\n<left>Available Trains<right><available_trains> <icon_Train>\r\n<left>Under construction<right><trains_in_construction> <icon_Train>\r\n\r\n<left>Construction cost:<right><resource(ConstructTrainCostMetal, ConstructResourceMetal)>\r\n<right><resource(ConstructTrainCostMP, ConstructResourceMP)>"),
					'RolloverTitle', T(14371, --[[XTemplate TransportationOverviewRow RolloverTitle]] "Construct Train"),
					'RolloverHint', T(14372, --[[XTemplate TransportationOverviewRow RolloverHint]] "<left_click> Construct Train\r\n<right_click> Decommission Train or Cancel Train Construction"),
					'RolloverHintGamepad', T(14373, --[[XTemplate TransportationOverviewRow RolloverHintGamepad]] "<ButtonA> Construct Train\r\n<ButtonX> Decommission Train or Cancel Train Construction"),
					'ZOrder', 100000,
					'VAlign', "center",
					'LayoutHSpacing', 0,
					'Background', RGBA(0, 0, 0, 0),
					...
					'FXPress', "MenuItemClick",
					'FocusedBackground', RGBA(0, 0, 0, 0),
					'OnPressParam', "ConstructTrain",
					'OnPress', function (self, gamepad)
						self.context:ConstructTrain(1)
					end,
					'AltPress', true,
					'OnAltPress', function (self, gamepad)
						self.context:ConstructTrain(-1)
					...
					PlaceObj('XTemplateWindow', {
						...
						'Dock', "left",
						'HandleMouse', true,
						'Image', "UI/Icons/IPButtons/train_button.tga",
						'ImageFit', "smallest",
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XImage",
				...
				PlaceObj('XTemplateWindow', {
					'comment', "toggle transport",
					'__dlc', "prunariu",
					'__condition', function (parent, context) return IsKindOf(context, "Track") end,
					'__class', "XTextButton",
					'RolloverTemplate', "Rollover",
					'RolloverAnchor', "right",
					'RolloverAnchorId', "node",
					'RolloverText', T(14374, --[[XTemplate TransportationOverviewRow RolloverText]] "Set Trains on this route to transport only colonists, resources or both.<newline><newline>Current status: <UITransportModeCurrentStatus><em>"),
					'RolloverTitle', T(11423, --[[XTemplate TransportationOverviewRow RolloverTitle]] "Toggle Transport Mode"),
					'RolloverHint', T(11501, --[[XTemplate TransportationOverviewRow RolloverHint]] "<left_click> Toggle Transport Mode"),
					'RolloverHintGamepad', T(11502, --[[XTemplate TransportationOverviewRow RolloverHintGamepad]] "<ButtonA> Toggle Transport Mode"),
					'ZOrder', 100000,
					'VAlign', "center",
					'LayoutHSpacing', 0,
					'Background', RGBA(0, 0, 0, 0),
					...
					'OnContextUpdate', function (self, context, ...)
						...
						local img = string.gsub(mode_to_img, "%%s", context.transport_mode)
						local button_icon = table.find_value(self, "Id", "idButtonIcon")
						if button_icon:SetImage() ~= img then
							button_icon:SetImage(img)
						end
					end,
					'FXMouseIn', "MenuItemHover",
					'FXPress', "MenuItemClick",
					...
					PlaceObj('XTemplateWindow', {
						...
						'Dock', "left",
						'HandleMouse', true,
						'Image', "UI/Icons/IPButtons/shuttle_transport_all.tga",
						'ImageFit', "smallest",
					}, {
						PlaceObj('XTemplateWindow', {
							'__class', "XImage",
