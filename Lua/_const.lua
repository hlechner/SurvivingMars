...
DefineConst{
	group = "Buildings",
	help = T(8632, --[[ConstDef Buildings ConstructionNanitesTimeDelta help]] "How often the construction nanite tech picks up resources from nearby storages."),
	id = "ConstructionNanitesTimeDelta",
	name = T(8633, --[[ConstDef Buildings ConstructionNanitesTimeDelta name]] "Construction Nanites Time Delta"),
	value = 3000,
}
DefineConst{
	group = "Buildings",
...
DefineConst{
	group = "Stat",
	help = T(8807, --[[ConstDef Stat NonHomeDomeServiceThresholdDecrement help]] "Service threshold penalty for colonists being serviced in another connected dome"),
	id = "NonHomeDomeServiceThresholdDecrement",
	name = T(8808, --[[ConstDef Stat NonHomeDomeServiceThresholdDecrement name]] "Connected dome service threshold penalty"),
	scale = "Stat",
	value = 10000,
}
DefineConst{
